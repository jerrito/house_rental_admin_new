...
class _SigninPageState extends State<SigninPage> {
  ...
  final formPhoneNumberKey = GlobalKey<FormBuilderState>();
  final formEmailKey = GlobalKey<FormBuilderState>();
        ...
        bottomSheet: bottomSheetButton(
          ...
          onPressed: () {
            if (type == UseNumber.emailPassword) {
              ...
              if (formPhoneNumberKey.currentState?.validate() == true) {
                authBloc.add(
